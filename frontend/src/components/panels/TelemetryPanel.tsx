          ...
          {logs.map((log, i) => (
            <p
              ...
              className={`text-[11px] font-mono leading-relaxed px-2 py-0.5 rounded ${
                i === 0 ? "text-zinc-300 bg-zinc-800/30" : "text-zinc-500"
              }`}
            >
              {log}
            </p>
...
export function TelemetryPanel() {
  ...
  return (
    <Card
      className="glass-panel rounded-xl border-0 animate-slide-up"
      ...
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-semibold text-zinc-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Badge
              variant="outline"
              className="border-zinc-700/30 bg-zinc-800/30 text-zinc-500 text-[9px] rounded-lg"
            >
      ...
      <CardContent className="pt-0">
        <Tabs defaultValue="rpm" className="w-full">
          <TabsList className="bg-zinc-800/30 border border-zinc-700/15 mb-3 rounded-xl p-1 h-auto">
            <TabsTrigger
              value="rpm"
              className="text-xs text-white data-[state=active]:bg-cyan-500/10 data-[state=active]:text-cyan-400 data-[state=active]:shadow-none rounded-lg transition-all duration-200 gap-1"
            >
            ...
            <TabsTrigger
              value="voltage"
              className="text-xs text-white data-[state=active]:bg-amber-500/10 data-[state=active]:text-amber-400 data-[state=active]:shadow-none rounded-lg transition-all duration-200 gap-1"
            >
            ...
            <TabsTrigger
              value="logs"
              className="text-xs text-white data-[state=active]:bg-emerald-500/10 data-[state=active]:text-emerald-400 data-[state=active]:shadow-none rounded-lg transition-all duration-200 gap-1"
            >
